    ...
    <div class="modal-body">
        <div class="row">            
            ...
            <div class="col-md-4 customer_fields">
                ...
                <!--Check this-->
                <div class="form-group hidden-field" id="group-password-container">
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="fas fa-lock"></i>
                        </span>
                        {!! Form::text('group_password', '', ['class' => 'form-control', 'id' => 'group_password', 'autocomplete' => 'off']); !!}
                        <span class="input-group-addon" id="group-password-check">@show_tooltip(__('For this option a password is required'))</span>
                    </div>
                </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        $( '#customer_group_id' ).on('change', function() {
                            ...
                            $( '#group_password' ).attr('required', false);
                            if( !$('#group-password-container').hasClass('hidden-field') ) $('#group-password-container').addClass('hidden-field');
                           ...
                           // reset_pos_form_price_group();
                            if( $(this).val() == '2' ){
                               ...
                               // alert('Your choice is 20%');
                                ...
                                if( $('#group-password-container').hasClass('hidden-field') ) $('#group-password-container').removeClass('hidden-field');
                            }
                        });
                        //when clicked empty the input
                        $( '#group_password' ).on('click', function() {
                            $(this).val('');
                        });
                        ...
                        $("#group_password").blur(function(){
                            ...
                            if(dsoft_required == md5_pwd){
                                $('#group-password-check').html('<i class="fas fa-check-circle" style="color:#006600"></i>');
                            }
                            else{
                                $('#group-password-check').html('<i class="fas fa-times-circle" style="color:#CC0000"></i>');
                                $(this).val('');
                            }
                        });
                    }, false);
