...
<script type="text/javascript">
	...
	//this Only Changes First line of Price Groups it needs to individually change all price groups input values
	var twenty = (purchase_exc_tax + purchase_exc_tax * 20 /100);
        __write_number(tr.find('input.twenty'), twenty);
		
	var thirty = (purchase_exc_tax + purchase_exc_tax * 30 /100);
        __write_number(tr.find('input.thirty'), thirty);
