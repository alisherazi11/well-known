        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('unit_id', __('product.unit') . ':*') !!}
              {!! Form::select('unit_id', $units, '(PC)', ['class' => 'form-control select2', 'required']); !!}
          </div>
        </div>
      ...
      @endphp
        <div class="col-sm-4">
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('not_for_selling', 1, true, ['class' => 'input-icheck']); !!} <strong>@lang('lang_v1.not_for_selling')</strong>
