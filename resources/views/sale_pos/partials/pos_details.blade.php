						...
						<td>
							...
							<div class="col-sm-3 col-xs-6 col-2px-padding">
								@if(!empty($pos_settings['show_credit_sale_button']))
									...
									<button type="button" 
									class="btn bg-purple btn-block btn-flat no-print pos-express-finalize"     border-radius: 10px;
...
.btn-warning btn-block btn-flat @if($pos_settings['disable_draft'] != 0) hide @endif  {
    border-radius: 10px;
}
