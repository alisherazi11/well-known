<div class="output">
	...
	<table class="receipt" style="width: 47%" >
		<thead>
			<tr>
				<td>
					<p style="float: left">
					 ...
					 {{ $receipt_details->sales_person_label }}  {{$payment['method']}} {{ $receipt_details->sales_person }} {{$payment['method']}}
					@endif	
					</small>
					...
					<p style="float: right">
						<small class="text-muted-imp">
						@if(!empty($receipt_details->sales_person_label))
				Delivery On  :</strong>  {!!$receipt_details-> shipping_custom_field_1_value ?? ''!!} 
					@endif	
					</small>
				</p>
				</td>
...
<!--
		...
		<div class="col-xs-12">
			<table class="table table-bordered table-no-top-cell-border table-slim mb-12">
			    	<div class="watermark"><br> CUSTOMER COPY  </div>
							...
							<div class="watermark3" ><br>   {{$payment['method']}} {!! $receipt_details->invoice_heading !!} </div>
                           	<div class="watermark4" ><br>   {!!$receipt_details-> shipping_custom_field_1_value ?? ''!!}  </div>
                           	
            	<thead>
					
					<tr style="background-color: #357ca5 !important; color: black ; font-weight: bold; !important; font-size: 20px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
						<td style="background-color: #357ca5 !important; black ; font-weight: bold;: red !important; width: 5% !important">#</td>
						...
						@if(!empty($receipt_details->item_discount_label))
							...
							@endphp
						@endif
						<td style="background-color: #357ca5 !important; color: black; font-weight: bold; !important; width: 220px !important">
							{{$receipt_details->table_product_label}}
						</td>
						<td style="background-color: #357ca5 !important; color: black ; font-weight: bold;!important; width: 15% !important;">
	...
	<div class="row invoice-info " style="page-break-inside: avoid !important">
		<div class="col-md-6 invoice-col width-50">
			<table class="table table-slim" style="color: white ; font-weight: bold; !important">
		...
		<div class="col-md-6 invoice-col width-50">
			<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
				<tbody>
					...
					<!-- Total -->
					<tr>
						<th style="background-color: #357ca5 !important; color: black ; font-weight: bold; !important" class="font-23	 padding-10">
							{!! $receipt_details->total_label !!}
						</th>
						<td class="text-right font-23 padding-1" style="background-color: #357ca5 !important; color: black ; font-weight: bold; !important">
	...
	<table class="receipt" style="width: 3%" >
	<!--CUSTOMER COPY -->
			...
			<tr>
				<td>
					<p style="float: left">
						<small class="text-muted-imp">
						@if(!empty($receipt_details->sales_person_label))
					 {{ $receipt_details->sales_person_label }}  {{ $receipt_details->sales_person }} {{$payment['method']}}
					@endif	
					</small>
					...
					<p style="float: right">
						<small class="text-muted-imp">
						@if(!empty($receipt_details->sales_person_label))
				Deliver On  :</strong>  {!!$receipt_details->shipping_custom_field_1_value ?? ''!!} 
					@endif		
					</small>
				</p>
