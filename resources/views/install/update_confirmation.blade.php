          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <form class="form" id="details_form" method="post" 
                    ...
                    <h4> Human Verification <small class="text-danger">Make sure to Enter Required Information</small></h4>
                    <hr/>
                    ...
                    <div class="col-md-12">
                        <button type="submit" id="install_button" class="btn btn-primary pull-right">Please Update</button>
                    </div>
              </form>
            </div>
          <!-- /.box-body -->
